...
function addAdventureToDOM(adventures) {
  ...
  //   ele.setAttribute("class","col-sm-6 col-lg-3 my-4");
  //   ele.innerHTML=`
  //   <a href="detail/?adventure=${element.id}" id=${element.id}>
  //     <div class="card activity-card-image"> 
  //         <img src=${element.image}>
  //         <div class="activity-card d-flex flex-lg-row flex-column align-items-center justify-content-lg-between">
